...
import com.platform.hierarchy.security.JwtFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/super/**").hasRole("SYSTEM_OWNER")
                .requestMatchers("/api/admin/**").hasAnyRole("SYSTEM_OWNER", "MANAGER")
                .requestMatchers("/api/user/**").hasAnyRole("SYSTEM_OWNER", "MANAGER", "CUSTOMER")
